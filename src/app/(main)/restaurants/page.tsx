...
import { getRestaurantDetail } from '@/lib/api/resto'; // ini terpaksa ditambahkan karena design figma minta ada jarak di recommended, tapi untuk area ini di backend tidak kirimkan koordinat jadi terpaksa harus diambil dari detail setiap restoran yang memberikan koordinat. untung hanya ada 6 resto jadi tidak berat.
  ...
  const filterContent = (
    <div className='flex flex-col gap-6 py-4'>
      ...
      <div className='flex flex-col gap-[10px] px-4'>
        <p className='text-lg font-extrabold text-neutral-950 tracking-[-0.02em] leading-8'>
          Distance
        </p>
        {distanceOptions.map((opt) => (
          ...
          >
            <CheckboxItem
              ...
              onClick={() =>
                updateParam('range', range === opt.value ? '' : opt.value)
              }
            />
      ...
      <div className='flex flex-col gap-[10px] px-4'>
        ...
        <div className='flex items-center gap-2 h-[54px] border border-neutral-300 rounded-md px-2'>
          <div className='w-[38px] h-[38px] bg-neutral-100 rounded-[4px] flex items-center justify-center shrink-0'>
            <span className='text-base font-bold text-neutral-950 tracking-[-0.02em] leading-[30px]'>
              Rp
            </span>
          </div>
          <Input
        ...
        <div className='flex flex-col'>
          {ratingOptions.map((r) => (
            <div
              key={r}
              onClick={() =>
                updateParam('rating', rating === String(r) ? '' : String(r))
              }
    ...
    <div className='min-h-screen flex flex-col bg-white'>
      ...
      <main className='flex-1 px-4 lg:px-[120px] pt-20 lg:pt-32 pb-12'>
        ...
        <div className='lg:hidden flex items-center justify-between p-3 mb-4 bg-white rounded-xl shadow-[0px_0px_20px_rgba(203,202,202,0.25)]'>
          <span className='text-sm font-extrabold text-neutral-950 leading-7'>
            FILTER
          </span>
...
/>
                  ...
                  {restaurants.map((restaurant) => (
                    ...
                    >
                      ...
                      <div className='flex flex-col gap-0.5 flex-1 min-w-0'>
                        <p className='text-base font-extrabold text-neutral-950 leading-[30px] truncate'>
                          {restaurant.name}
                        </p>
  ...
  <span className='text-sm font-normal text-neutral-950 tracking-[-0.02em] leading-7 truncate'>
    {restaurant.place}
  </span>
                ...
                <div className='hidden lg:grid grid-cols-2 gap-5'>
                  {restaurants.map((restaurant) => (
                    ...
                    >
                      ...
                      />
                      {/* di api back end ku cek memang gaada distance datanya, hanya tempatnya. Apa jangan-jangan pakai connect lokasi?  */}
                      <div className='flex flex-col gap-0.5 flex-1 min-w-0'>
                        <p className='text-lg font-extrabold text-neutral-950 tracking-[-0.02em] leading-8 truncate'>
                          {restaurant.name}
                        </p>
                        <div className='flex items-center gap-1'>
                          <Star
                            ...
                            className='text-accent-yellow shrink-0'
                          />
                          <span className='text-base font-medium text-neutral-950 leading-[30px] tracking-[-0.03em]'>
                            {restaurant.star}
                          </span>
                        </div>
                       <div className='flex items-center gap-1.5 min-w-0'>
  <span className='text-base font-normal text-neutral-950 tracking-[-0.02em] leading-[30px] truncate'>
    {restaurant.place}
  </span>
  {userCoords && restaurantCoords[restaurant.id] && (
    <>
